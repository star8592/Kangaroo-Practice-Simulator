...
def main():
 ...
 for r in rows:
  ...
  if not canonical or canonical!=fresh: rej.append((k,'independent_extractions_not_exact'));continue
  ...
  out.append({'examId':r['examId'],'questionNo':r['questionNo'],'sourceLanguage':'en','sourceKey':key,
   ...
   'verificationMethod':'deterministic_exact_agreement_sourceMeta_vs_pdftotext_crop_plus_frozen_crop',
