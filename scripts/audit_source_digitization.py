...
def main():
 ...
 verified={}
 for vp in [root/'private/source-digitization/verified-official-html.json',root/'private/source-digitization/verified-official-html-visual.json']:
  if vp.exists():
 ...
 for j in data.get('jobs',[]):
  ...
  if vr:
   ...
   status='SOURCE_VERIFIED' if not issues and origin in {'manual','official_pdf_manual_repair'} else ('NEEDS_SOURCE_REVIEW' if text else 'RAW')
