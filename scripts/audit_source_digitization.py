...
def main():
 ...
 verified={}
 for vp in [root/'private/source-digitization/verified-official-html.json',root/'private/source-digitization/verified-official-html-visual.json',root/'private/source-digitization/verified-official-pdf.json',root/'private/source-digitization/verified-official-pdf-manual.json',root/'private/source-digitization/verified-portugal-pdf-region.json',root/'private/source-digitization/verified-germany-pdf-region.json',root/'private/source-digitization/verified-austria-pdf-region.json',root/'private/source-digitization/verified-austria-legacy-pdf.json',root/'private/source-digitization/verified-maa-pdf.json']:
  if vp.exists():
