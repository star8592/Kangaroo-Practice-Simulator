...
def main():
 ...
 try:
  ...
  print(json.dumps({'auth':'PASS','pre_a_questions':25,'pre_a_distribution':{'3':10,'4':10,'5':2,'6':2,'8':1},'pre_a_untimed':True,'pre_a_full_score':100,'pre_a_blank_score':0,'amc_middle_primary_minutes':60,'amc_middle_primary_max':135,'answer_leak':False,'student_admin_access':403,'maa_amc8_archive_2000':25,'maa_amc8_2024':25,'maa_amc8_smart':25,'maa_amc10_blank_score':37.5,'maa_practice_separate':True,'analytics_attempts':3,'analytics_questions':75,'login_rate_limit':True,'session_revocation':True},ensure_ascii=False))
 finally:cleanup(uid)
